...
urlpatterns = [
    ...
    path('profile/<int:pk>/modifier/', views.profile_update, name='profile_update'),
    ...
    path('reception/<int:pk>/export-excel/', views.reception_export_excel, name='reception_export_excel'),
